...
var use_location_default = ({base = ""} = {}) => {
  const [pathAndSearch, update] = (0, import_react.useState)(() => ({
    path: currentPathname(base),
    search: location.search
  }));
  const prevHash = (0, import_react.useRef)(pathAndSearch.path + pathAndSearch.search);
...
var flattenChildren = (children) => {
  return Array.isArray(children) ? [].concat(...children.map((c) => c.type === import_react.Fragment ? flattenChildren(c.props.children) : flattenChildren(c))) : [children];
};
