...
export default function Home() {
    return (
        <div className="position-relative d-flex flex-column align-items-center justify-content-center flex-grow-1">
            <img src={me} style={profileStyle} className="mb-5" />
            ...
            <div className="mt-5">
                <a href="mailto:mainendra@gmail.com" aria-label="mail">
                    <svg style={iconStyle} width="1em" height="1em" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://github.com/mainendra" aria-label="github">
                    <svg style={iconStyle} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                ...
                <a href="https://dev.to/mainendra" aria-label="dev.to">
                    <svg style={iconStyle} viewBox="0 0 50 40" fill="#000000" xmlns="http://www.w3.org/2000/svg">
